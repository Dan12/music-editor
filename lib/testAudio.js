...
$(document).ready(function () {
    ...
    function getData(callback, drawCallback) {
    ...
    var drawCallback = function (buffer) {
        ...
        $("#test_canvas").mousemove(function (event) {
            $("#mouseLocation").html(String(((event.pageX - $("#test_canvas").offset().left) / (xZoom * 48000)).toFixed(4)));
        });
    };
