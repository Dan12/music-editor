...
define(["require", "exports", '../../abstracts/facade', './d-nav-bar', './l-nav-bar'], function (require, exports, facade_1, d_nav_bar_1, l_nav_bar_1) {
    ...
    var NavBarFacade = (function (_super) {
        ...
        function NavBarFacade(parent) {
            _super.call(this, 'nav_bar', parent, 'nav');
            this.draw_class = new d_nav_bar_1.NavBarDraw(this.container);
            this.logic_class = new l_nav_bar_1.NavBarLogic();
        }
        return NavBarFacade;
