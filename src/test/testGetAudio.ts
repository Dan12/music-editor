export function getAudio(audioCtx: AudioContext, fileName: string, callback: (sound: AudioBufferSourceNode) => void): void{
    ...
    errorFunc = function(e?: DOMException){"Error with decoding audio data" + e.err}
